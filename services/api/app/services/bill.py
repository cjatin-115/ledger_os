...
class BillService:
    ...
    async def create(
        ...
        if abs(expected_taxable - payload.taxable_amount) > Decimal("1.00"):
            raise ValueError("Taxable amount does not match subtotal and discount.")
    ...
    def _valid_gstin(gstin: str) -> bool:
        ...
        return bool(re.fullmatch(r"(?:0[1-9]|[12][0-9]|3[0-8])[A-Z0-9]{13}", value))